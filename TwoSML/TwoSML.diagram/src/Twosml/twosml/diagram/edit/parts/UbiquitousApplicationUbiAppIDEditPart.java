 ...
 * @generated
 */
public class UbiquitousApplicationUbiAppIDEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public UbiquitousApplicationUbiAppIDEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new Twosml.twosml.diagram.edit.policies.TwoSMLTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = Twosml.twosml.diagram.providers.TwoSMLParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					Twosml.twosml.diagram.edit.parts.TwoSMLEditPartFactory
