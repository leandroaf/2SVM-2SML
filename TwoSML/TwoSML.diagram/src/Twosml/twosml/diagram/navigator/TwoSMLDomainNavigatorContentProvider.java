 ...
 * @generated
 */
public class TwoSMLDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public TwoSMLDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof Twosml.twosml.diagram.navigator.TwoSMLDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((Twosml.twosml.diagram.navigator.TwoSMLDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new Twosml.twosml.diagram.navigator.TwoSMLDomainNavigatorItem(
